 ...
 *
 * 配置:
 *   DEEPSEEK_API_KEY 环境变量或同目录 .env 文件
 *   DEEPSEEK_BASE_URL 默认 https://api.deepseek.com/v1
 *   VISION_MODEL 默认 deepseek-v4-flash-vision-exp
 */
...
async function main() {
  if (!API_KEY) {
    console.error("请设置 DEEPSEEK_API_KEY 环境变量或在 .env 文件中配置。");
